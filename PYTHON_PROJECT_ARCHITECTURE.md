...
- Одна выбранная рабочая версия Blender для всех заданий. В образ входят 5.2.0,
  4.5.11 LTS, 4.2.22 LTS, 4.1.1 и 3.6.23 LTS; дополнительные версии
  устанавливаются пользователем из официального архива.
...
Сервис хранит одну `active_version`; по умолчанию это 4.5.11 LTS. Установка новой
...
- В образе закреплены Blender 5.2.0, 4.5.11 LTS, 4.2.22 LTS, 4.1.1 и
  3.6.23 LTS; одна версия явно выбирается как рабочая для всех jobs.
